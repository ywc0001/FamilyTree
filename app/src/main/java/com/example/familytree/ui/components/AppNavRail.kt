...
package com.example.familytree.ui.components
...
import com.example.familytree.ui.FamilytreeDestinations
...
fun AppNavRail(
    ...
    NavigationRail(
        ...
        NavigationRailItem(
            selected = currentRoute == FamilytreeDestinations.HOME_ROUTE,
        ...
        NavigationRailItem(
            selected = currentRoute == FamilytreeDestinations.INTERESTS_ROUTE,
...
fun PreviewAppNavRail() {
    FamilytreeTheme {
        AppNavRail(
            currentRoute = FamilytreeDestinations.HOME_ROUTE,
            navigateToHome = {},
            navigateToInterests = {},
        )
    }
