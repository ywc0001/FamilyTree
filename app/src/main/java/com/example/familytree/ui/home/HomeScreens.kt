...
import com.example.familytree.ui.article.postContentItems
import com.example.familytree.ui.article.sharePost
import com.example.familytree.ui.components.FamilytreeSnackbarHost
import com.example.familytree.ui.modifiers.interceptKey
import com.example.familytree.ui.theme.FamilytreeTheme
import com.example.familytree.ui.utils.BookmarkButton
import com.example.familytree.ui.utils.FavoriteButton
import com.example.familytree.ui.utils.ShareButton
import com.example.familytree.ui.utils.TextSettingsButton
...
private fun HomeScreenWithList(
    ...
    Scaffold(
        snackbarHost = { FamilytreeSnackbarHost(hostState = snackbarHostState) },
        topBar = {
            if (showTopAppBar) {
                HomeTopAppBar(
                    openDrawer = openDrawer,
