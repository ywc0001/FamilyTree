...
import com.example.familytree.data.successOr
import com.example.familytree.glance.ui.theme.FamilytreeGlanceColorScheme
...
class FamilytreeGlanceAppWidget : GlanceAppWidget() {
    override val sizeMode: SizeMode = SizeMode.Exact

    override suspend fun provideGlance(context: Context, id: GlanceId) {
        val application = context.applicationContext as FamilytreeApplication
        ...
        provideContent {
            ...
            GlanceTheme(
                colors = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    ...
                    FamilytreeGlanceColorScheme.colors
                }
            ) {
                FamilytreeContent(
